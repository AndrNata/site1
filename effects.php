    ...
    <main role="main">
      ...
      <div class="container mt-4">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card">
                <img src="images/133483506.jpg" class="img-fluid pic1" alt="">
          ...
          <div class="col-md-4">
              <div class="card">
                <img src="images/Desert.jpg" class="img-fluid pic2" alt="">
                  <div class="card-body text-center">
      ...
      <div class="container mt-4">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              <img src="images/Desert.jpg" class="img-fluid pic3" alt="">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="div">
                  <p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Текста, раз города вскоре за гор точках великий переписывается осталось щеке снова? Составитель точках залетают за журчит, несколько, пунктуация даже!</p>
                </div>
                <div class="card-body">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="animate">
                <p>Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Рыбными ручеек рукопись раз рот последний даль всеми реторический залетают переулка коварный страна приставка, несколько вдали по всей домах, снова она!</p>
              </div>
              <div class="card-body">
