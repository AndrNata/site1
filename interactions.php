...
?>
  ...
  <div class="container mt-4">
       <div class="row">
         ...
         <div class="col-md-4">
           <img src="images/37_1.jpg" class="img-fluid drag" alt="">
         </div>
         <div class="col-md-4">
           <img src="images/37_2.jpg" class="img-fluid drag" alt="">
         </div>
         <div class="col-md-4">
     ...
     <div class="container mt-4">
         <div class="row">
           ...
           <div class="col-md-8">
             <img src="images/1372088626.jpg" class="drag1" width="200" alt="">
             <img src="images/133483506.jpg" class="drag1" width="200" alt="">
             <img src="images/Desert.jpg" class="drag1" width="200" alt="">
           </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card resize">
                <img src="images/Цветок.jpg" class="card-img-top" alt="">
                <div class="card-body">
                  <p class="card-text">Далеко-далеко за словесными горами в стране, гласных и согласных живут рыбные тексты. Строчка вдали путь даль продолжил послушавшись свой агенство однажды снова журчит переписали пустился, они, себя то диких предупреждал инициал единственное.</p>
                </div>
              </div>
            </div>
          </div>
